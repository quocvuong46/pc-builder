-- ================================================
-- SCRIPT KHỞI TẠO HOÀN CHỈNH DATABASE
-- Chạy script này để tạo database với đầy đủ dữ liệu
-- ================================================
...
SELECT 'CPU' as table_name, COUNT(*) as record_count FROM cpu
UNION ALL
SELECT 'Mainboard', COUNT(*) FROM mainboard
UNION ALL
SELECT 'RAM', COUNT(*) FROM ram
UNION ALL
SELECT 'VGA', COUNT(*) FROM vga
UNION ALL
SELECT 'Storage', COUNT(*) FROM storage
UNION ALL
SELECT 'PSU', COUNT(*) FROM psu
UNION ALL
SELECT 'Case', COUNT(*) FROM pc_case
UNION ALL
SELECT 'Cooler', COUNT(*) FROM cooler;
